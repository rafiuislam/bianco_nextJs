    ...
    <section className="container mx-auto mt-4 px-4 sm:pb-2 py-4 md:px-24">
      ...
      <p className="text-justify text-secondary font-regular text-md font-raleway bg-cover bg-center animate-fadeIn relative">
        <span className="relative">
          ...
          <br /> By acknowledging our terms and conditions through purchase, or
          subscriptions, you confirm that you have reviewed and accepted this
          document, which forms the foundation of our agreement with you. When
          you place an order for any of our products, you consent to abide by
          these terms and conditions. Please note that Bianco Bangladesh retains
          the authority to modify any information without giving prior notice.
        </span>
      </p>
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              reached the age of majority in your state or province of residence
              or that you have attained the age of majority and have provided
              consent for any minor dependents under your care to utilize this
              website. Failure to comply with any of the specified terms shall
              lead to an immediate termination of the services provided to you.
            </span>
          </p>
        </div>
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              facilitating deliveries to you, conducting credit assessments, and
              providing you with offers and information regarding our catalogue.
              Rest assured that the information you provide is strictly
              accessible to Bianco Bangladesh and shall not be disclosed to any
              third parties.
            </span>
          </p>
        </div>
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              information. However, please be aware that historical information
              is not current and is only provided for reference purposes. We
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              the content, technology implemented, or privacy practices of these
              third-party websites. Your use of such websites is entirely at
              your own risk. Prior to registering or using any third-party
              website, we strongly advise you to review their privacy policy and
              terms of use to ensure they meet your standards.
            </span>
          </p>
        </div>
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              purchase the products selected in your order. We reserve the right
              to accept or reject any order at our sole discretion. You are
              responsible for providing accurate and complete information when
              placing an order. We shall not be liable for any delays or errors
              resulting from inaccurate or incomplete information provided by
              you. Payment for the products must be made at the time of placing
              the order. We accept payment through the methods specified on the
              Website.
            </span>
          </p>
        </div>
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              address provided by you within the estimated delivery time frame.
              Risk of loss or damage to the products passes to you upon
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              damaged or defective product, please contact us within 48 hours of
              delivery to arrange for a return or exchange.
            </span>
          </p>
        </div>
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              reason, please reach out to us using the contact details provided
              in the
