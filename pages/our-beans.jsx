          ...
          <FadeAndScale offset="-300px 0px -300px 0px">
            <p className="lg:mb-6 pb-2 md:pb-0 text-center text-secondary font-regular text-md font-raleway bg-cover bg-center animate-fadeIn relative">
              <span className="relative z-10">
                ...
                the pleasure of enjoying the flavours, <br /> aroma, and ritual
                of coffee without the stimulating effects of caffeine. The
                decaffeination process typically removes about 97–99% <br /> of
                the caffeine present in the beans, meaning there may still be a
                small amount remaining. On average, an 8-ounce cup of decaf
                coffee <br />
                contains around 2–5 milligrams of caffeine, significantly less
                than regular coffee, which typically contains 80–100 milligrams
                per cup.
              </span>
            </p>
          </FadeAndScale>
                ...
                <div className="">
                  ...
                  <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
                    <span className="relative z-10">
                      ...
                      mg of caffeine, compared to a typical cup of regular
                  ...
                  <div className="mt-1 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center animate-slideFromLeft relative">
                    ...
                    <ul className="pl-8">
                      ...
                      <li>
                        ...
                        solvent to extract caffeine. The CO2 is pressurised and
                        passed through the coffee beans, where it binds with the
                        caffeine molecules. The caffeine-laden CO2 is then
                        depressurized and evaporated, leaving behind
                        decaffeinated beans.
                      </li>
                      <li>
                        <span className="text-justify text-secondary font-semi-bold text-sm font-raleway">
                        ...
                        caffeine and flavours. The water is then passed through
                        a carbon filter that selectively captures the caffeine
                        molecules.
                      </li>
                      <li>
                        <span className="text-justify text-secondary font-semi-bold text-sm font-raleway">
                        ...
                        separated and heated to evaporate the caffeine, leaving
                        behind decaffeinated beans.
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-1 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center animate-slideFromLeft relative">
                    <span className="relative z-10">
                      ...
                      with coffee cooperatives. This strategy ensures access to
                      a diverse range of specialty coffee beans from different
                      regions worldwide.
                    </span>{" "}
                  </p>
                </div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-1 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center animate-slideFromLeft relative">
                    <span className="relative z-10">
                      ...
                      different origins. They conduct rigorous cupping sessions
                      to assess the beans aroma, flavour profile, acidity, body,
