    ...
    <section className="container mx-auto mt-4 px-4 sm:pb-2 py-4 md:px-24">
      ...
      <div className="text-justify text-secondary font-regular text-md font-raleway bg-cover bg-center animate-fadeIn relative">
        <span className="relative">
          ...
          customers personal information. By accessing our website or providing
          us with your personal information, you consent to the practices
          described below.
        </span>
      </div>
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <div className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              address, phone number, and postal address when you place an order,
              create an account, or subscribe to our newsletter. This
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              information and take appropriate measures to safeguard it against
              unauthorized access, loss, or disclosure. We utilize
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              enhance your browsing experience and collect information about how
              you interact with our site. These technologies enable us to
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              maintained by the Company or its service providers. <br /> <br />{" "}
              To maintain the confidentiality, security, and integrity of your
              personal information, we have implemented various physical,
              electronic, contractual, and administrative measures. However, it
              is important to note that no method of transmission over the
              Internet or electronic storage is entirely foolproof, and we
              cannot guarantee absolute security. It is your responsibility to
              keep your account information, including your username and
              password, confidential. You are accountable for all activities
              carried out on the Websites using your account. Should you become
              aware of any unauthorized use of your account or any actual or
              suspected security breach related to the Websites, please promptly
              notify us at info@bianco-bd.com.
            </span>
          </p>
        </div>
        ...
        <div className="lg:pt-8 pt-4 animate-fadeIn">
          ...
          <p className="mt-1 mb-4 text-justify text-secondary font-regular text-sm font-raleway bg-cover bg-center relative">
            <span className="relative z-10">
              ...
              provided us with their personal information, please contact us
              immediately, and we will take appropriate steps to remove that
